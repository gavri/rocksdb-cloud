...
const std::unordered_map<std::string, OptionTypeInfo>
    CloudFileSystemOptions::cloud_fs_option_type_info = {
        ...
        {"resync_on_open",
         ...
         OptionType::kBoolean}},
        {"roll_cloud_manifest_on_open",
         {offset_of(&CloudFileSystemOptions::roll_cloud_manifest_on_open),
          OptionType::kBoolean}},
        {"cookie_on_open",
         {offset_of(&CloudFileSystemOptions::cookie_on_open),
          OptionType::kString}},
        {"new_cookie_on_open",
         {offset_of(&CloudFileSystemOptions::new_cookie_on_open),
          OptionType::kString}},
